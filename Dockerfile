...
RUN apt-get update && apt-get -y upgrade && apt-get install -y git python3.7 python3-pip python3-dev libpython3-dev libpython3.7-dev && python3.7 -m pip install --upgrade pip

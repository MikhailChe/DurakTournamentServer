...
RUN apt-get update && apt-get install -y python3.7 python3-pip libpython3.7-dev vim && python3.7 -m pip install --upgrade pip virtualenv && rm -rf /var/lib/apt/lists/*
COPY . /app
